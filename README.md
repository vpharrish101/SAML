...
Paper: https://anonymous.4open.science/r/SAML-ra-D151/SAML_2nd_paper.pdf
...
We solve this by: -
  ...
  4.  We now sample and project the scan data, using spectral Fourier Features(RFF) and let a learned gate decide which of the 3 projections contain the most signal. RFF here is used as a helper for GNN, so the final weight of RFF contribution is also learnt.
